...
When using our Service, you may need to create an AlphaBrate account to access certain features. We expect you to provide and maintain accurate, current, and complete information during the registration process. You are responsible for the confidentiality of your account and password, and for restricting access to your account. You agree to accept responsibility for all activities that occur under your account or password and to notify us immediately of any unauthorized use of your account or password or any other breach of security. For information on how we handle your data privacy, please refer to our Privacy Policy.

### ii. Account Termination

We reserve the right to terminate or suspend your account at any time without notice if we believe you have violated these Terms of Service. You may terminate your account at any time by contacting us. Upon termination, your right to use the Service will immediately cease. All provisions of these Terms of Service that by their nature should survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity, and limitations of liability.

### iii. Account Security

You are responsible for maintaining the security of your account and password. We cannot and will not be liable for any loss or damage from your failure to comply with this security obligation. You are responsible for all activities that occur under your account, whether or not you know about them. If you suspect that your account has been compromised, please contact us immediately. We will not be liable for any loss or damage arising from your failure to comply with these security obligations.

### iv. Account Data

For information on how we handle your account data, please refer to our Privacy Policy.
...
The server has limitations on the number of users and the amount of data that can be stored. If the server reaches its limit, the service will be suspended and restarted. You can visit the server’s URL to reactivate the service.
